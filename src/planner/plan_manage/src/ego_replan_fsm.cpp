...
namespace ego_planner
{
  ...
  void EGOReplanFSM::init(ros::NodeHandle &nh)
  {
    ...
    else if (target_type_ == TARGET_TYPE::PRESET_TARGET)
    {
      ...
      /////////////////////////////////////////////////////////////////////////////////////////////
      wp_target_pub = nh.advertise<geometry_msgs::PoseStamped>("/wp_target", 10);
      //////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
    wp_target.pose.position.x = waypoints_[waypoint_num_ - 1][0];
    wp_target.pose.position.y = waypoints_[waypoint_num_ - 1][1];

    wp_target_pub.publish(wp_target);
    ///////////////////////////////////////////////////////////////////////////////////////////////
  }
