...
namespace ego_planner
{
  ...
  private:
    ...
    geometry_msgs::PoseStamped  wp_target;
    ...
    ros::Publisher replan_pub_, new_pub_, bspline_pub_, data_disp_pub_, swarm_trajs_pub_, broadcast_bspline_pub_, wp_target_pub;
